 ...
 * @author andrewserff
 */
public class Log4JLoggerTSV implements EventLogger {

    private static final Logger log = LogManager.getLogger(Log4JLoggerTSV.class);
    ...
    private void logEvent(String event) {
        try {
            ...
            String theJson = mapper.writeValueAsString(theValue);

            dataLogger.info(fromJsonToCSV(theValue));
    ...
    private String fromJsonToCSV(Object o){
        StringBuffer sb = new StringBuffer();
        if (o instanceof LinkedHashMap ) {
            for (Object s : ((LinkedHashMap) o).keySet()) {
                sb.append(((LinkedHashMap) o).get(s));
                sb.append("\t");
            }
