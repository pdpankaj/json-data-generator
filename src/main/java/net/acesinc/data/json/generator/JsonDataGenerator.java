...
public class JsonDataGenerator {
        ...
        try {
            ...
            for (Map<String, Object> elProps : simConfig.getProducers()) {
                ...
                switch (elType) {
                    ...
                    case "loggerTSV": {
                        log.info("Adding Log4JLoggerTSV Producer");
                        loggers.add(new Log4JLoggerTSV());
                        break;
                    }
                    case "file": {
                    ...
                    case "kafkaTSV": {
                        log.info("Adding KafkaTSV Producer with properties: " + elProps);
                        loggers.add(new KafkaLoggerTSV(elProps));
                        break;
                    }
                    case "tranquility": {
    ...
    public static void main(String[] args) {
        ...
        if (args.length > 0) {
            ...
            log.info("You need to pass a configuration file as argument.");
            System.exit(1);
        }
