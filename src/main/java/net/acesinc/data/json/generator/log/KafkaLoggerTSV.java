 ...
 * @author andrewserff
 */
public class KafkaLoggerTSV implements EventLogger {

    private static final Logger log = LogManager.getLogger(KafkaLoggerTSV.class);
    ...
    public KafkaLoggerTSV(Map<String, Object> props) {
    ...
    private void logEvent(String event) {
        ...
        try {
            result = new ObjectMapper().readValue(event, HashMap.class);
        } catch (IOException e) {
            e.printStackTrace();
        }

        String output = fromJsonToCSV(result);
    ...
    private String fromJsonToCSV(HashMap hm){
        StringBuffer sb = new StringBuffer();
        sb
                .append(hm.get("TradeID")).append("\t")
                .append(hm.get("tradeDate")).append("\t")
                .append(hm.get("venue")).append("\t")
                .append(hm.get("cpty")).append("\t")
                .append(hm.get("dir")).append("\t")
                .append(hm.get("ccypair")).append("\t")
                .append(hm.get("amt")).append("\t")
                .append(hm.get("price")).append("\t")
                .append(hm.get("valueDate"));
        return sb.toString();
    }
}
